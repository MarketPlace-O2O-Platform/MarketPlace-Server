...
public class QNotificationRes extends ConstructorExpression<NotificationRes> {
    ...
    public QNotificationRes(com.querydsl.core.types.Expression<Long> id, com.querydsl.core.types.Expression<String> title, com.querydsl.core.types.Expression<String> body, com.querydsl.core.types.Expression<Long> targetId, com.querydsl.core.types.Expression<com.appcenter.marketplace.domain.notification.TargetType> targetType, com.querydsl.core.types.Expression<Boolean> isRead, com.querydsl.core.types.Expression<java.time.LocalDateTime> createdAt) {
        super(NotificationRes.class, new Class<?>[]{long.class, String.class, String.class, long.class, com.appcenter.marketplace.domain.notification.TargetType.class, boolean.class, java.time.LocalDateTime.class}, id, title, body, targetId, targetType, isRead, createdAt);
    }
