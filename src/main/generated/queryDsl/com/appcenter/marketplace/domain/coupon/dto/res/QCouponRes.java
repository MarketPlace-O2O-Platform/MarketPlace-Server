...
public class QCouponRes extends ConstructorExpression<CouponRes> {
    ...
    public QCouponRes(Expression<Long> couponId, Expression<String> couponName, Expression<String> couponDescription, Expression<java.time.LocalDateTime> deadLine, Expression<Integer> stock, Expression<Boolean> isHidden, Expression<Long> marketId, Expression<String> marketName, Expression<com.appcenter.marketplace.domain.member_coupon.CouponType> couponType) {
        super(CouponRes.class, new Class<?>[]{long.class, String.class, String.class, java.time.LocalDateTime.class, int.class, boolean.class, long.class, String.class, com.appcenter.marketplace.domain.member_coupon.CouponType.class}, couponId, couponName, couponDescription, deadLine, stock, isHidden, marketId, marketName, couponType);
    }
