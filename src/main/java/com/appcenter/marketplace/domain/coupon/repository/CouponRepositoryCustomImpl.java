...
import com.appcenter.marketplace.domain.coupon.dto.res.QCouponMemberResDto;
import com.appcenter.marketplace.domain.coupon.dto.res.QCouponResDto;
...
public class CouponRepositoryCustomImpl implements CouponRepositoryCustom {
    ...
    public List<CouponResDto> findOwnerCouponResDtoByMarketId(Long marketId) {
         ...
         return jpaQueryFactory.select(new QCouponResDto(coupon.id,
                         ...
                         coupon.isHidden))
                 .from(coupon)
                 .join(coupon).on(coupon.market.id.eq(market.id))
